...
int main(int argc, char* argv[])
{
    ...
    rclcpp::Subscription<std_msgs::msg::String>::SharedPtr all_function_show_sub;
    rclcpp::Subscription<std_msgs::msg::String>::SharedPtr iat_answer_text_sub;
    // rclcpp::Subscription<user_interfaces::msg::State>::SharedPtr ulaa_state_sub;
    ...
    all_function_show_sub = node->create_subscription<std_msgs::msg::String>("all_function_show", 1000, iattextQuestionCallback); //subscribe question reault
    ...
    // ulaa_state_sub = node->create_subscription<user_interfaces::msg::State>("state",10,updateState);//subscribe ulaa state
	tts_text_pub = node->create_publisher<std_msgs::msg::String>("tts2speech", 1000);  //publish text to voice string 语音播报请求
    face_pub     = node->create_publisher<std_msgs::msg::String>("face_action", 10); //表情演示
    base_pub     = node->create_publisher<std_msgs::msg::String>("pub_msgs", 10); 
    body_pub     = node->create_publisher<std_msgs::msg::String>("armAction", 10); // 手臂动作
