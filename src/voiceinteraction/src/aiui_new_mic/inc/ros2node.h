...
public:
    AIUINewMic(std::string name) : Node(name) {
	    ...
	    speak_state_pub       = this->create_publisher<chat_msgs::msg::State>("speak_state",10);
        ...
        ulaa_state_sub = create_subscription<chat_msgs::msg::State>(
    ...
    chat_msgs::msg::State ulaa_state; 
    std_msgs::msg::String string_msg_body;
    rclcpp::Publisher<std_msgs::msg::String>::SharedPtr body_pub;//手臂动作发布
    rclcpp::Publisher<chat_msgs::msg::State>::SharedPtr speak_state_pub; // 说话状态发布
...
private:
    ...
    rclcpp::Subscription<chat_msgs::msg::State>::SharedPtr ulaa_state_sub;//ulaa状态订阅
    ...
    chat_msgs::msg::State speak_pos_msg;
