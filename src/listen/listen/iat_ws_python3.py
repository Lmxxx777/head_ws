...
class Ws_Param(object):
    ...
    def __init__(self, APPID, APIKey, APISecret, AudioFile):
        ...
        # TODO：vad_eos是说话停顿多久会设置为结束，dwa是动态修正，vinfo
        self.BusinessArgs = {"domain": "iat", "language": "zh_cn", "accent": "mandarin",
                             "vinfo": 1, "vad_eos": 10000, "dwa": "wpgs"}
...
wsParam = Ws_Param(APPID='8b722e6c', APISecret='ODkxYmQ0MzZhNmRmYTFkZWJkMmNmYWY4',
                    ...
                    AudioFile=r'/home/imi/head_ws/src/listen/resource/test_1.pcm')
...
def on_message(ws, message):
    try:
        ...
        if code != 0:
            ...
            # result_2 = json.loads(message["data"])["result"]
            # a = ''
            # for i in result_2:
            #     for x in i['ws']:
            #         w = x['cw'][0]['w']
...
def ListenContent():
    ...
    listen_content = content[-2] + content[-1]
